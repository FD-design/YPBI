...
开发文档当前对首批清单总数同时写有“27项 / 26项”，需由开发统一。测试后台本轮实查中，M001/M003/M005/M016/M026/M081/M034/M036/M097 返回 READY；M006/M007/M090 返回 SOURCE_INCOMPLETE；M020/M021/M022/M023/M060/M084/M086/M112/M113/M114/M115 返回 PROCESSING，其余项目尚未通过正式准入。本批不新增诊断路由或数据源维护功能。没有现成页面位置、正式维度契约或仍明确标记为演示的数据，不因 Token 切换自动变成真实数据；需要先登记页面映射后才展示。
