...
| 独立产品 BI 平台 | 独立产品注册、数据源、卡片库、模板中心和看板；首个产品 NewAV，与原 PID/双 Token 数据源完全隔离 | `new-platform/src`、`new-platform/server` | [独立平台架构](./new-platform/architecture.md)、[NewAV API 清单](./new-platform/newav0-api-inventory.md) | 本地真实数据接入完成 | 2026-08-25：12 个接口真实调用通过 |
