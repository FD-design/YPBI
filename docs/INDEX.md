...
| 独立产品 BI 平台 | 复用成熟 BI 工作台、12 类图表、下钻、双周期、卡片库和模板管理；首个产品 NewAV，与原 PID/双 Token 数据源完全隔离 | `new-platform/src`、`new-platform/server` | [独立平台架构](./new-platform/architecture.md)、[NewAV API 清单](./new-platform/newav0-api-inventory.md) | 线上真实数据运行中 | 2026-08-26：修复批量查询超时与冗余上游请求 |
