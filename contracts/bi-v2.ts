...
export const v2DataEnvironmentSuccessSchema = z.object({
  success: z.literal(true),
  data: z.discriminatedUnion("mode", [
    ...
    z.object({
      mode: z.literal("test"),
      testAvailable: z.literal(true),
      expiresAt: z.iso.datetime(),
      userName: boundedText(256)
    }).strict()
  ])
}).strict();

export type V2DataEnvironmentSuccess = z.infer<typeof v2DataEnvironmentSuccessSchema>;

export const v2ApiErrorCodeSchema = z.enum([
  "IDENTITY_PROVIDER_UNAVAILABLE",
  "AUTHENTICATION_REQUIRED",
  "BI_READ_ACCESS_DENIED",
  "INVALID_DATA_ENVIRONMENT",
  "DATA_PREVIEW_DISABLED",
  "DATA_PREVIEW_SESSION_REQUIRED",
  "PID_ACCESS_DENIED",
  "INVALID_V2_REQUEST",
