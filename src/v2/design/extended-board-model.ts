...
export const EXTENDED_BOARDS: Record<string, ExtendedBoard> = {
  ...
  "5.13": { sections: [{ title: "发现、搜索与视频互动", ids: ["M044", "M092", "M093", "M046", "M047", "M048"], columns: 3 }, { title: "视频首页一级分类导航", ids: ["M106", "M107", "M108"], columns: 3, note: "分类层级：一级 · 仅统计主动分类点击" }, { title: "视频点击来源", ids: ["M109"], columns: 2, note: "全局页面 / 列表来源与视频首页一级分类上下同显；分类 Tab 点击另行统计" }, { title: "作者与社区", ids: ["M049", "M050", "M051"], columns: 3 }], dimensions: [{ title: "一级分类导航比较", ids: ["M106", "M107", "M108"], groups: ["一级分类 Tab"] }, { title: "视频首页一级分类内容点击", ids: ["M109"], groups: ["一级内容分类"] }, { title: "内容发现结构", ids: ["M044"], groups: ["位置"] }, { title: "搜索需求", ids: ["M092", "M093", "M046"], groups: ["搜索词", "搜索类型"] }, { title: "视频互动排行", ids: ["M047", "M048"], groups: ["视频", "视频类型"] }, { title: "作者与社区明细", ids: ["M049", "M050", "M051"], groups: ["作者", "帖子", "内容类型"] }] },
  ...
  "5.15": { sections: [{ title: "启动核心", ids: ["M080", "M091"], columns: 2, note: "启动成功率按可判定终态计算；应用启动次数只作为样本规模背景。" }], dimensions: [{ title: "启动结构与质量诊断", ids: ["M080", "M091"], groups: ["客户端平台", "启动类型", "版本"] }] }
};
